...
$readmeContent += "### 2. Set up the Python SDK`n"
$readmeContent += "```powershell`n"
$readmeContent += "cd zvml-python-sdk`n"
$readmeContent += "pip install -e .`n"
$readmeContent += "````n`n"
$readmeContent += "### 3. Set up the Hands-On Labs`n"
$readmeContent += "```powershell`n"
$readmeContent += "cd Zerto-Python-SDK-Hands-On-Labs`n"
$readmeContent += "copy prerequisites\config.example.py prerequisites\config.py`n"
$readmeContent += "````n`n"
$readmeContent += "### 4. Create Virtual Environment`n"
$readmeContent += "```powershell`n"
$readmeContent += "cd Zerto-Python-SDK-Hands-On-Labs`n"
